...
// Add a custom test listener to better display test results
...
//         std::cout << (test_info.result()->Passed() ? "[PASSED] " : "[FAILED] ")
...
// int main(int argc, char **argv) {
    ...
    // Enable more detailed test output
    ...
    // listeners.Append(new TestEventListener()); // Will be deleted automatically by Google Test
    ...
    //
    // std::cout << "=== Test end with result: " << result << " ===" << std::endl;
    // std::cout.flush();
