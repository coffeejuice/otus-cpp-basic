...
TEST(BasicTest, AlwaysTrue) {
    std::cout << "Running BasicTest.AlwaysTrue test case" << std::endl;
    ASSERT_TRUE(true);
}

// A helper function to print to ensure code is executing
void __attribute__((constructor)) premain() {
    std::cout << "This runs before main - if you see this, the executable is running" << std::endl;
}

// Add a simple container test
TEST(ContainerBasic, SimpleTest) {
    std::cout << "Running a simple container test" << std::endl;
...
template <typename T>
void fill_container_with_data(T& container, int start, int count) {
